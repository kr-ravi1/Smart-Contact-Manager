...
function UpdateContact() {
  ...
  const handleUpdateContact = async (e) => {
    ...
    const response = await fetch(`http://localhost:8080/user/contact/update/${id}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      <div className='grid grid-cols-12'>
        ...
        <div className='col-span-12 md:col-span-6'>
          <div className="block p-6 bg-gray-50 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <h1 className='text-2xl font-semibold'>Udate Contact</h1>
            <p className='text-gray-500 dark:text-gray-400 text-sm'>This Contact will be updated on cloud.</p>

            <form onSubmit={handleUpdateContact} className='mt-8'>
