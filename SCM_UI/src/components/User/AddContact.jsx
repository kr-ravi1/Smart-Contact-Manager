                        ...
                        <form onSubmit={handleAddContact} className='mt-8'>
                            ...
                            <div className='mb-1'>
                                ...
                                <div className="relative mb-6">
                                    ...
                                    <input type="text" id="email" name='email' value={contactData.email} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="example@gmail.com" />
                                </div>
                            </div>
                            ...
                            <div className='mb-1'>
                                ...
                                <div className="relative mb-6">
                                    ...
                                    <input type="text" id="phone" name='phoneNumber' value={contactData.phoneNumber} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="620xxxxxxx" />
                                </div>
                            </div>
                            ...
                            <div className='mb-1'>
                                ...
                                <div className="relative mb-6">
                                    ...
                                    <input type="text" id="address" name='address' value={contactData.address} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Address" />
                                </div>
                            </div>
                            ...
                            <div className='mb-1'>
                                ...
                                <div className="relative mb-6">
                                    ...
                                    <input type="text" id="description" name='description' value={contactData.description} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Something about contact..." />
                                </div>
                            </div>
                            ...
                            <div className="flex items-center mb-4">
                                <input id="checkbox" type="checkbox" name='isFavourite' checked={setContactData.isFavourite}  onChange={handleChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
