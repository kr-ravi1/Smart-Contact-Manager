        ...
        <nav className='bg-white border-gray-200 dark:bg-gray-800'>
            <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
                <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="../images/phone.png" className="h-7" alt="Flowbite Logo" />
                ...
                <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse gap-2">
                    ...
                    <button 
                        id='theme-btn'
                        type="button" 
                        className="text-white bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-gray-500 dark:hover:bg-gray-300 dark:focus:ring-gray-400"
                        onClick={changeTheme}
